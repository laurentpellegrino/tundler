...
docker run -it -d \
  ...
  -e SURFSHARK_OPENVPN_USERNAME="$SURFSHARK_OPENVPN_USERNAME" \
  -e SURFSHARK_OPENVPN_PASSWORD="$SURFSHARK_OPENVPN_PASSWORD" \
  -e SURFSHARK_PROTOCOL="$SURFSHARK_PROTOCOL" \
  -e SURFSHARK_WIREGUARD_KEYS="$SURFSHARK_WIREGUARD_KEYS" \
