...
docker run -it -d \
  ...
  -e PROTON_OPENVPN_USERNAME="${VPN_PROTON_OPENVPN_USERNAME:-$PROTON_OPENVPN_USERNAME}" \
  -e PROTON_OPENVPN_PASSWORD="${VPN_PROTON_OPENVPN_PASSWORD:-$PROTON_OPENVPN_PASSWORD}" \
  -e PROTON_OPENVPN_PROTOCOL="${VPN_PROTON_OPENVPN_PROTOCOL:-$PROTON_OPENVPN_PROTOCOL}" \
  -e PROTON_OPENVPN_PORT="${VPN_PROTON_OPENVPN_PORT:-$PROTON_OPENVPN_PORT}" \
  -e PROTON_SERVERS_URL="${VPN_PROTON_SERVERS_URL:-$PROTON_SERVERS_URL}" \
